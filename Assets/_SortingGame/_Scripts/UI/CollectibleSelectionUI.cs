...
button.SetImage(collectibleDataSO.collectibleUISprite);

// Get the RectTransform component of the button
RectTransform buttonRectTransform = button.GetComponent<RectTransform>();

// Change the anchor to the left center
buttonRectTransform.anchorMin = new Vector2(0f, 0.5f); // Left center anchor
buttonRectTransform.anchorMax = new Vector2(0f, 0.5f); // Left center anchor

// Set the anchoredPosition to (0, 0) to place the button at the center of the anchor
buttonRectTransform.anchoredPosition = new Vector2(0, 0); // Adjust Y as needed for vertical positioning
